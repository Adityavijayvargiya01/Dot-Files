...
Item {
  ...
  property int headerHeight: Style.font.heading + Style.space(12)
  property int contentSpacing: Style.space(6)
  property int baseRowHeight: Style.font.heading + Style.space(16)
  property int detailRowHeight: Style.font.heading + Style.font.bodySmall + Style.space(16)
  property int emptyStateHeight: Style.font.displayLarge + Style.font.title + Style.space(24)
  ...
  property int rowSpacing: Style.space(3)
  property int dividerHeight: Style.space(6)
  property bool searchDivider: false
  property int layoutSerial: 0
  property int cardWidth: Math.min(root.dmenuActive ? Style.space(root.dmenuWidth) : ((root.activeMenu === "trigger.capture.screenrecord" || root.activeMenu === "style.font") ? Style.space(520) : Style.space(420)), panel.width - Style.gapsOut * 2)
  ...
  function foldedListHeight(totals, available) {
    ...
    if (count === 0) return root.emptyStateHeight
          ...
          ListView {
            ...
            delegate: BorderSurface {
              ...
              Item {
                ...
                readonly property bool showDetail: (root.filterText || row.kind === "dmenu") && row.detail.length > 0
                ...
                Text {
                  ...
                  anchors.rightMargin: detailText.visible ? Style.space(10) : 0
                  anchors.verticalCenter: parent.verticalCenter
                  text: row.label
                  color: row.hasCursor ? root.selectedText : root.foreground
                  font.family: root.fontFamily
                ...
                Text {
                  ...
                  anchors.right: parent.right
                  anchors.verticalCenter: parent.verticalCenter
                  visible: contentColumn.showDetail
                  text: row.detail.replace(/ > /g, " · ")
                  color: root.foreground
                  opacity: 0.4
                  font.family: root.fontFamily
                  font.pixelSize: Style.font.caption
                  elide: Text.ElideLeft
                  width: Math.min(implicitWidth, Math.round(contentColumn.width * 0.5))
                }
              }
